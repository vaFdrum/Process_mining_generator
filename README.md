...
**Переделки (rework)** (вероятность 6–8% по конфигу, длительность 15–90 мин):
...
131 тест: бизнес-логика, бизнес-календарь, генерация кейсов, CSV-запись, конфигурации, интеграция.
